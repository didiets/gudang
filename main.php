<!-- Aplikasi Persediaan Barang Gudang CV ANCA
************************************************************************
* Developer   : Code Null
* Company     : Code Null
* Release     : Mei 2021
...
// jika user sudah login, tampilkan halaman konten
  ...
  <head>
    ...
    <meta name="description" content="Aplikasi Persediaan Barang Gudang CV ANCA" />
    <meta name="author" content="Code Null" />

    <!-- Title -->
    <title>Aplikasi Persediaan Barang Gudang CV ANCA</title>
        ...
        <div class="logo-header" data-background-color="purple">
          ...
          <a href="?module=dashboard" class="logo">
            <div class="navbar-brand">
              ...
              <span class="text-white">GUDANG CV ANCA</span>
            </div>
          </a>
          <!-- Navbar Toggler -->
